...
<head>
    ...
    <title>JivaJoy Admin | Data Pesanan</title>
    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 style="color: #4380a8; margin-bottom: 10px;">Data Pesanan</h1>
                <button class="btn btn-primary btn-rounded" id="buttonPrimary">
                    <a href="/dashboard/orders/create" class="text-white text-decoration-none">Tambah Data</a>
                </button>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $order->status == 'Menunggu Konfirmasi Pembayaran' ? 'active' : '' }}">
                            ...
                            <td class="col-3">
                                <button class="btn btn-primary btn-rounded" id="buttonPrimary">
                                    <a href="/dashboard/orders/{{ $order->kode_pesanan }}" class="text-white text-decoration-none">Detail</a>
                                </button>
                                <button class="btn btn-warning btn-rounded"><a href="/dashboard/orders/{{ $order->kode_pesanan }}/edit" class="text-white text-decoration-none">Edit</a></button>
