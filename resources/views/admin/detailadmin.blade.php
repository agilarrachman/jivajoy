...
<body>
    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <div class="mt-4">
                <form>
                    <img id="profileImagePreview" src="{{ asset('storage/' . $admin->foto_profil) }}" alt="" class="rounded-circle my-3" style="width: 140px; height: 140px; object-fit:cover;">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" value="{{ $admin->nama }}" disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="password" value="{{ $admin->password }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">No HP</label>
                        <input type="text" class="form-control" id="phone" value="{{ $admin->no_hp }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="gender" class="form-label">Jenis Kelamin</label>
                        <input type="text" class="form-control" id="gender" value="{{ $admin->jenis_kelamin }}" disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="date" value="{{ $admin->created_at }}" disabled>
                    </div>
                </form>
                <a href="/dashboard/admin" class="btn btn-rounded my-3" id="buttonPrimary">Kembali</a>
                <button class="btn btn-warning btn-rounded" style="min-width: 80px;"><a href="/dashboard/admin/{{ $admin->username }}/edit" class="text-white text-decoration-none">Edit</a></button>
                <form action="/dashboard/admin/{{ $admin->username }}" method="post" class="d-inline" style="min-width: 80px;">
                    @method('delete')
                    @csrf
