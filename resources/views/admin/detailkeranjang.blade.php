...
<head>
    ...
    <title>JivaJoy Admin | Detail Keranjang</title>
    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="/dashboard/carts" class="btn btn-secondary btn-rounded">Kembali</a>
            </div>
            ...
            <div>
                <div class="mb-3 form-input d-flex flex-column">
                    ...
                    <img src="{{ $cart->product->foto_produk }}" class="img-product" alt="Gambar Produk" style="width:fit-content; height: 200px; object-fit:cover;">
                </div>

                <div class="mb-3 form-input">
                    <label for="productName" class="form-label">Varian Produk</label>
                    <input type="text" class="form-control" id="productName" name="product_name" value="Jivajoy {{ $cart->product->varian }}" readonly>
                </div>


                <div class="mb-3 form-input">
                    <label for="productStock" class="form-label">Nama Customer</label>
                    <input type="text" class="form-control" id="productStock" name="product_stock" value="{{ $cart->customer->nama }}" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="productStock" class="form-label">Email Customer</label>
                    <input type="text" class="form-control" id="productStock" name="product_stock" value="{{ $cart->customer->email }}" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="productStock" class="form-label">Jumlah</label>
                    <input type="text" class="form-control" id="productStock" name="product_stock" value="{{ $cart->qty }} pcs" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="productStock" class="form-label">Total Harga</label>
                    <input type="text" class="form-control" id="productStock" name="product_stock" value="Rp {{ number_format($cart->total_harga, 0, ',', '.') }}" readonly>
                </div>
