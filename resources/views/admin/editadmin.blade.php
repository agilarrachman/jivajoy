...
<head>
    ...
    <meta name="description"
        content="Aromaterapi 2in1 (Inhaler & Roll On) dari Kemangi dan Cendana Sebagai Upaya Mencegah Baby Blues dengan Kemasan Website Terintegrasi">
    <title>JivaJoy Admin | Edit Admin</title>
...
<body>
    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <form action="/dashboard/admin/{{ $admin->username }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="col d-flex flex-column w-80">
                    <img id="profileImagePreview" src="{{ asset('storage/' . $admin->foto_profil) }}" alt="" class="rounded-circle my-3">
                ...
                <div class="form-floating my-3">
                    <input type="text" name="nama" class="form-control  @error('nama') is-invalid @enderror" id="nama" placeholder="Nama Lengkap" autofocus required value="{{ old('nama', $admin->nama ) }}">
                ...
                <div class="form-floating my-3">
                    <input type="text" name="username" class="form-control  @error('username') is-invalid @enderror" id="username" placeholder="username" autofocus required value="{{ old('username', $admin->username ) }}">
                ...
                <div class="form-floating my-3">
                    <input type="email" name="email" class="form-control  @error('email') is-invalid @enderror" id="email" placeholder="name@example.com" autofocus required value="{{ old('email', $admin->email ) }}">
                ...
                <div class="mb-2">
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="Pria" value="Pria" {{ old('jenis_kelamin', $admin->jenis_kelamin) == 'Pria' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Pria">
                            Pria
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="Wanita" value="Wanita" {{ old('jenis_kelamin', $admin->jenis_kelamin) == 'Wanita' ? 'checked' : '' }}>
                ...
                <div class="form-floating my-3">
                    <input type="number" name="no_hp" class="form-control  @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Laki-laki" autofocus required value="{{ old('no_hp', $admin->no_hp) }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="role" name="role" required>
                        ...
                        <option value="Customer" {{ old('role', $admin->role) == 'Customer' ? 'selected' : '' }}>Customer</option>
                    </select>
                </div>
                <a href="/dashboard/admin" class="btn btn-secondary btn-rounded my-3" style="border-radius: 30px;">Batal</a>
