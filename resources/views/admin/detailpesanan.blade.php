...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="sidebar">
            ...
            <br><br>
            <a href="{{ url('/admin/datacustomer') }}" class="{{ request()->is('admin/datacustomer') ? 'active' : '' }}">Data Customer</a>
            <a href="{{ url('/admin/dataproduk') }}" class="{{ request()->is('admin/dataproduk') ? 'active' : '' }}">Data Produk</a>
            <a href="{{ url('/admin/datakeranjang') }}" class="{{ request()->is('admin/datakeranjang') ? 'active' : '' }}">Data Keranjang</a>
            <a href="{{ url('/admin/datapesanan') }}" class="{{ request()->is('admin/datapesanan') ? 'active' : '' }}">Data Pesanan</a>
            <a href="{{ url('/admin/chat') }}" class="{{ request()->is('admin/chat') ? 'active' : '' }}">Chat</a>
        </div>
    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ url('/admin/datapesanan') }}" class="btn btn-secondary btn-rounded">Kembali</a>
            </div>
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-input">
                    ...
                    <input type="text" class="form-control" id="orderId" name="order_id" value="123456" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="customerId" class="form-label">ID Customer</label>
                    <input type="text" class="form-control" id="customerId" name="customer_id" value="CUST789" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="customerName" class="form-label">Nama Customer</label>
                    <input type="text" class="form-control" id="customerName" name="customer_name" value="John Doe" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="productVariant" class="form-label">Varian yang Dibeli</label>
                    <input type="text" class="form-control" id="productVariant" name="product_variant" value="Inhaler" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="totalPrice" class="form-label">Total Harga</label>
                    <input type="number" class="form-control" id="totalPrice" name="total_price" value="250000" readonly>
                </div>

                <div class="mb-3 form-input">
                    <label for="address" class="form-label">Alamat</label>
                    <textarea class="form-control" id="address" name="address" rows="3" readonly>123 Main Street, Jakarta</textarea>
                </div>

                <div class="mb-3 form-input">
                    <label for="orderStatus" class="form-label">Status Pesanan</label>
                    <select class="form-select" id="orderStatus" name="order_status" disabled>
    ...
    <!-- JavaScript Files -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-Rpg8bAOB5F6d2T5DoSR6+e2Y9mO2X0tS8OfiG7anTkH8Be0XEOjTk5OaF7zz9hR9" crossorigin="anonymous"></script>
</body>
