                    ...
                    <div class="about_main-info">
                        ...
                        <div class="order-section">
                            ...
                            <div class="row d-flex flex-column flex-md-row w-100 my-3 g-3">
                                ...
                                <form class="col-12 col-md-6" action="/carts" method="POST" id="cart-form">
                                    @csrf
                                ...
                                <!-- Form untuk Checkout -->
                                <form class="col-12 col-md-6" action="/order/checkout" method="get" id="checkout-form">
                                    @csrf
                                    <input type="hidden" name="id_customer" value="{{ auth()->user()->id }}">
                                    <input type="hidden" name="id_product" id="checkout-variant">
                                    <input type="hidden" name="qty" id="checkout-quantity">
                                    <input type="hidden" name="total_harga" id="checkout-total-price">
                                    <button type="submit" style="border-radius: 30px;">
