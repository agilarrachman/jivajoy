...
<head>
    ...
    <title> JivaJoy | Akun Profile</title>
        ...
        <div class="row flex-md-row flex-sm-column">
            <div class="col-md-3 mb-5 w-sm-100">
                <div class="d-flex flex-column gap-3">
                    <a href="/profile">
                        <button id="btn-open-profil" type="button" class="btn-side btn-active btn text-start p-3 rounded-4 shadow-sm d-flex items-center gap-3 border">
                    ...
                    <a href="/order">
                        <button id="btn-open-history" type="button" class="btn-side btn text-start p-3 rounded-4 shadow-sm d-flex items-center gap-3 border">
            ...
            <div class="col-md-9 w-md-60 m-sm-auto w-sm-100">
                <div id="section-profil" class="px-md-5 pt-0 w-100">
                    ...
                    <form method="post" action="/profile/user/" class="mt-1">
                        @method('put')
                        @csrf
                        <div class="position-relative w-100 mt-4">
                            <img id="profileImagePreview" src="{{ asset('storage/' . auth()->user()->foto_profil) }}" alt="" class="rounded-circle my-3 mx-auto mx-md-0">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" required value="{{ old('nama', auth()->user()->nama ) }}">
                            @error('nama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-2">
                            <div class="form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="Pria" value="Pria"
                                    {{ old('jenis_kelamin', auth()->user()->jenis_kelamin) == 'Pria' ? 'checked' : '' }}>
                            ...
                            <div class="form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="Wanita" value="Wanita"
                                    {{ old('jenis_kelamin', auth()->user()->jenis_kelamin) == 'Wanita' ? 'checked' : '' }}>
                        ...
                        <div class="d-flex flex-column gap-2 mt-3">
                            ...
                            <input type="number" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" required value="{{ old('no_hp', auth()->user()->no_hp ) }}">
                            @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
