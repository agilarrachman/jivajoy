        ...
        <div class="row flex-md-row flex-sm-column">
            <div class="col-md-3 mb-5 w-sm-100">
                <div class="d-flex flex-column gap-3">
                    ...
                    <a href="/cart">
                        <button id="btn-open-bucket" type="button" class="btn-side btn text-start p-3 rounded-4 shadow-sm d-flex items-center gap-3 border btn-active">
            ...
            <div class="col-md-9 w-md-60 m-sm-auto w-sm-100">
                <div id="section-bucket" class="px-md-5 pt-0 w-100">
                    ...
                    <div class="d-flex justify-content-end mt-5 gap-4 align-items-center">
                        <div class="">
                            <p class="mb-0 title-price">Total Harga</p>
                            <p class="price">Rp.24.999,-</p>
                        </div>
                        <button class="btn btn-checkout rounded-pill py-2 my-3" type="submit">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
